 ...
 local menuc8205c7636e728d448c2774e6a4a944b = {
     ...
     {"Prospect Mail", "\"/opt/Prospect Mail/prospect-mail\" --force-device-scale-factor=1 --disable-gpu-driver-bug-workarounds --disable-gpu-vsync --use-gl=desktop --ignore-gpu-blocklist --enable-gpu-rasterization --enable-zero-copy --disable-features=UseOzonePlatform --enable-features=VaapiVideoDecoder,WebUIDarkMode,CanvasOopRasterization --force-dark-mode ", "/usr/share/icons/hicolor/16x16/apps/prospect-mail.png" },
