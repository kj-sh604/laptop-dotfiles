 ...
 local menu98edb85b00d9527ad5acebe451b3fae6 = {
     ...
     {"Atom", "env ATOM_DISABLE_SHELLING_OUT_FOR_ENVIRONMENT=false /usr/bin/atom  --force-device-scale-factor=1 --disable-gpu-driver-bug-workarounds --disable-gpu-vsync --use-gl=desktop --ignore-gpu-blocklist --enable-gpu-rasterization --enable-zero-copy --disable-features=UseOzonePlatform,UseChromeOSDirectVideoDecoder --enable-features=VaapiVideoEncoder,VaapiVideoDecoder,WebUIDarkMode,CanvasOopRasterization --force-dark-mode", "/usr/share/icons/hicolor/16x16/apps/atom.png" },
